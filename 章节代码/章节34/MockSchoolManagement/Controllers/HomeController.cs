...
namespace MockSchoolManagement.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(IWebHostEnvironment webHostEnvironment, ILogger<HomeController> logger, IDataProtectionProvider dataProtectionProvider, DataProtectionPurposeStrings dataProtectionPurposeStrings, IRepository<Student, int> studentRepository, IStudentService studentService)
        {
        ...
        {
            //判断searchString如果不为空，去除查询参数中 空格
